...
<!-- LEFT PANEL -->
<div class="hidden lg:flex flex-col justify-center px-16 bg-gradient-to-br from-indigo-600 to-purple-600 text-white">
...
<div class="absolute -top-3 -right-3 bg-white text-indigo-600 text-xs font-semibold px-3 py-1 rounded-lg shadow">
AI Insights
</div>
...
<p id="strengthText" class="text-xs mt-2 text-slate-500"></p>
...
&
<a href="{{ route('privacy') }}" class="text-indigo-600 hover:underline">Privacy</a>
</span>
