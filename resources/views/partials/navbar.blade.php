    ...
    <div class="max-w-[1600px] mx-auto
        ...
        <div class="flex items-center gap-4">
            ...
            <button
                ...
                <i class="fa-solid transition duration-300"
                   :class="dark ? 'fa-sun text-amber-400 rotate-180' : 'fa-moon text-slate-600 dark:text-slate-300'">
                </i>
            </button>
               ...
               aria-label="Notifications">
                ...
                @if($unreadAlerts > 0)
                    <span class="absolute -top-1 -right-1
                                 ...
                                 bg-indigo-600 rounded-full text-center
                                 animate-pulse">
                        {{ $unreadAlerts }}
                    </span>
                @endif
            ...
            <div x-data="{ open:false }" class="relative">
                ...
                <div x-show="open"
                    ...
                    <a href="{{ route('user.profile.index') }}"
                       class="block px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-800 transition">
                        Profile
                    </a>
                    @endif
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <button type="submit"
                                class="w-full text-left px-4 py-2
                                       text-rose-600
                                       hover:bg-rose-50
                                       dark:hover:bg-rose-900/20 transition">
                            Logout
                        </button>
                    </form>
