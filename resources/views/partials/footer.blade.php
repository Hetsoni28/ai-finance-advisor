        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    ...
                    <li class="group">
                        <a href="{{ route('changelog') }}" @mouseenter="playHoverSound()" class="block text-sm font-bold text-slate-500 hover:text-emerald-600 transition-colors">
                    ...
                    @if(Route::has('blog'))
                    <li class="group">
                        <a href="{{ route('blog') }}" @mouseenter="playHoverSound()" class="block text-sm font-bold text-slate-500 hover:text-emerald-600 transition-colors">
                            <span class="flex items-center gap-2"><span class="w-0 overflow-hidden group-hover:w-3 transition-all text-emerald-400">&rarr;</span> Engineering Blog</span>
                        </a>
                    </li>
                    @endif
                </ul>
            ...
            <div>
                ...
                <ul class="space-y-4">
                    ...
                    @endif
                    @if(Route::has('dpa'))
                        <li class="group"><a href="{{ route('dpa') }}" @mouseenter="playHoverSound()" class="text-sm font-bold text-slate-500 hover:text-slate-900 transition-colors flex items-center gap-2"><span class="w-0 overflow-hidden group-hover:w-3 transition-all text-slate-400">&rarr;</span> Data Processing Addendum</a></li>
                    @endif
                    @if(Route::has('soc2'))
                        <li class="group"><a href="{{ route('soc2') }}" @mouseenter="playHoverSound()" class="text-sm font-bold text-slate-500 hover:text-slate-900 transition-colors flex items-center gap-2"><span class="w-0 overflow-hidden group-hover:w-3 transition-all text-slate-400">&rarr;</span> SOC2 Compliance</a></li>
                    @endif
                </ul>
            </div>
