            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 lg:gap-8 mb-16">
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-sm font-medium text-slate-500">
                        ...
                        <li><a href="#" class="hover:text-indigo-600 transition-colors">System Changelog</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-sm font-medium text-slate-500">
                        ...
                        <li><a href="#" class="hover:text-indigo-600 transition-colors">Careers & Hiring</a></li>
                        <li><a href="#" class="hover:text-indigo-600 transition-colors">Engineering Blog</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-sm font-medium text-slate-500">
                        ...
                        <li><a href="#" class="hover:text-indigo-600 transition-colors">Data Processing Addendum</a></li>
                        <li><a href="#" class="hover:text-indigo-600 transition-colors">SOC2 Compliance</a></li>
                    </ul>
                </div>
            </div>
