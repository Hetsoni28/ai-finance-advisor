...
Route::view('/dpa', 'pages.dpa')->name('dpa');
Route::view('/soc2', 'pages.soc2')->name('soc2');
...
Route::middleware('auth')->group(function () {
    ...
    */
    Route::prefix('user')->name('user.')->group(function () {
        ...
        Route::prefix('ai')->name('ai.')->group(function () {
            ...
            // NEW: Financial Intelligence Endpoints
            Route::get('/market', [AiChatController::class, 'marketSnapshot'])->name('market');
            Route::post('/goals', [AiChatController::class, 'storeGoal'])->name('goals.store');
            Route::post('/profile', [AiChatController::class, 'saveProfile'])->name('profile.save');
        });
        ...
        Route::prefix('profile')->name('profile.')->group(function () {
            ...
            // Redirect old subscription route to new module
    ...
    */
    Route::prefix('admin')
        ...
        Route::patch('/contacts/{contact}/toggle-read', [AdminContactController::class, 'toggleRead'])->name('contacts.toggleRead');
